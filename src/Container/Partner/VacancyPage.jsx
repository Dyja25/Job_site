...
function VacancyPage(props) {
  ...
  return (
    <React.Fragment >
      <div class="md:flex justify-center bg-slate-200 max-sm:overflow-x-hidden">
        <div>
      <div class="md:w-w7 bg-white ">
      {/* <Header/> */}
        <div class="w-wk h-18 max-sm:h-96">
...
<FormattedMessage
  ...
  <div class="flex flex-col justify-center max-sm:mt-0 items-center max-sm:px-2">
        
        <JobCard/>
        </div>
 
    <div class="text-sm flex justify-center mt-3 mb-8 text-gray-700 max-sm:px-4 max-sm:text-center"style={{fontFamily:"sans-serif"}} >
          Copyright © {new Date().getFullYear()} {` `} LIBAXIS B.V. All Rights Reserved.
        </div>
        </div>
        </div>
