...
import { addPartner, getSectors, getLibrarys } from "../../Jobsite/JobAction";
...
export default (
  connect(mapStateToProps, mapDispatchToProps)(PartnerForm)
);
