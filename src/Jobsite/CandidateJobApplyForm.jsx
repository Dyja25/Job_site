...
import SearchSelect from "../Components/Forms/Formik/SearchSelect.jsx";
...
import { TextareaComponent } from "../Components/Forms/Formik/TextareaComponent.jsx";
...
import { DaysCompressorWithMonth } from "./DaysCompressorWithMonth.jsx";
...
const CandidateSchema = Yup.object().shape({
  ...
  nationality:Yup.string().required("Input needed!"),
  // skills:Yup.string().required("Input needed!"),
...
class CandidateJobApplyForm extends Component {
  ...
  if (values.availableDate) {
    if (
      dayjs(currentDate).isBefore(dayjs(values.availableDate), "day")
    ) {
      return true;
    } else {
      return false;
