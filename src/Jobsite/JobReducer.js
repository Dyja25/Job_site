...
const initialState = {
  ...
  uploadJobDocument: false,
  uploadJobDocumentError: false,
  documentData:[],
  ...
  case types.ADD_CUSTOMER_DETAILS_FAILURE:
    ...
    case types.GET_ROLES_NAME_FAILURE:
      return { ...state, 
        ...
        case types.GET_DOCUMENT_DATA_SUCCESS:
          return { ...state, documentDataVendor: action.payload };

        
        case types.GET_PARSE_SUCCESS:
          return { ...state, parseData: action.payload };
    
          case types.UPLOAD_JOB_DOCUMENT_REQUEST:
            return { ...state, uploadJobDocument: true };
          case types.UPLOAD_JOB_DOCUMENT_SUCCESS:
            return { ...state, uploadJobDocument: false,
              documentData:action.payload, };
          case types.UPLOAD_JOB_DOCUMENT_FAILURE:
            return { ...state, 
              uploadJobDocument: false,
               uploadJobDocumentError: true };
